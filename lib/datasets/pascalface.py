...
class pascalface(imdb):
    def __init__(self, split):
        imdb.__init__(self, 'pascalface_' + split)
        self._classes = ['bg', 'face']
        self._dataset_path = cfg.DATA_DIR
        self._imgs_path = os.path.join(cfg.DATA_DIR, 'images')
        list_file = os.path.join(self._dataset_path, 'pascal_img_list.txt')
    ...
    def write_detections(self, all_boxes, output_dir='./output/'):
        ...
        txt_fname = os.path.join(output_dir, 'pascal_res.txt')
